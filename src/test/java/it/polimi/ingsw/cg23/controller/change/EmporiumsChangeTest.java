...
public class EmporiumsChangeTest {
	...
	public void setUp() throws Exception {
		...
		players = Arrays.asList(new Player("player1", new NobilityTrack(1)),
				new Player("player2", new NobilityTrack(1)), new Player("player3", new NobilityTrack(1)),
				new Player("player4", new NobilityTrack(1)));
	...
	public void testToString() {
		...
		assertEquals(change.toString(),
				"EmporiumsChange [ Emporiums= [City=A, Players=[player1, player2, player3, player4]]");
	}
