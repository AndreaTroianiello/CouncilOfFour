...
public class CreateMapTest {
	...
	/**
	 * it tests if after createMap the map contains the name of the regions, of
	 * the cities, of the players, and if each city contains his type
	 */
	@Test
	public void testCreateMapShouldCreateAMapThatContainsTheNameOfRegionsCitiesTypesAndPlayers() {
		...
		assertTrue(map.contains(reg.get(0).getName().toUpperCase()));// la mappa
																		// contiene
																		// il
																		// nome
																		// della
		...
		for (int i = 0; i < cities.size(); i++) {// ciclo che scorre le citta'
			assertTrue(map.contains(cities.get(i).getName()));// la mappa
																// contiene il
																// nome delle
																// citta'
			assertTrue(map.contains(cities.get(i).getType()));// la mappa
																// contiene il
																// colore (tipo)
																// delle citta'
		}
		assertTrue(map.contains(giocatori.get(0).getUser()));// la mappa
																// contiene il
																// nome dei
																// giocatori
	...
	/**
	 * it tests if after createMapDraw the map contains the name of the regions,
	 * of the cities, of the players, and if each city contains his type
	 */
	@Test
