...
public class MapSettingTest {
	...
	/**
	 * it tests if getCityFromRegion return the list of cities with all the
	 * Cities in cities
	 */
	@Test
	public void testGetCityFromRegionShouldCreateAListOfCitiesWithAllTheCitiesInCities() {
		...
		for (int i = 0; i < cities.size(); i++) {// puo' essere che non tutti i
													// parametri siano settati
	...
	/**
	 * it tests if addSpace adds spaces until the string reaches the wanted
	 * length if the string is smaller then the wanted length, and does nothing
	 * if it is greater
	 */
	@Test
	...
	/**
	 * it tests if printName returns the names of the regions in a string of the
	 * wanted length
	 */
	@Test
	...
	/**
	 * it tests if createCostructionShowed return a string with all the showed
	 * tiles of all the regions
	 */
	@Test
	...
	/**
	 * it tests if getNeighbourID returns a string with all the neighbors of the
	 * city passed
	 */
	@Test
	...
	/**
	 * it tests if bonusCouncilKingType returns a string with the king's council
	 * and his type
	 */
	@Test
