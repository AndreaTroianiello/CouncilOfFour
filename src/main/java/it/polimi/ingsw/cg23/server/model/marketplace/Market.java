...
public class Market implements Serializable {
	 ...
	 * 
	 * @param item
	 *            The business permit tile for sale.
	 * @param player
	 *            The player indicated.
	 */
	...
	public List<Player> generatePlayersList(List<Player> players) {
		...
		for (int index = players.size(); index > 0; index--) {
			...
			Player player = marketList.remove(randomIndex); // Get the player at
															// the random index.
