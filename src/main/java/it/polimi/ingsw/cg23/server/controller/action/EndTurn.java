...
/**
 * The action EndTurn is used to end turn and to notify the change of the
 * current player.
 * 
 * @author Andrea
 *
...
public class EndTurn extends Action {
	...
	/**
	 * Controls the status of view and if necessary change the state. If all
	 * views are suspended sets the status at finish.
	 * 
	 * @param controller
	 *            The controller of the game.
	 * @return if false all views are suspended or the current view isn't
	 *         suspended.
	 */
