...
/**
 * Type is the color of a city. Many cities have in common the same type's
 * object. A type is characterized by a name, a bonus and contains a list of
 * city.
 * 
 * @author Andrea
 *
...
public class Type implements Serializable {
	 ...
	 * 
	 * @param name
	 *            The name/color of type.
	 * @param points
	 *            The number of victory points that the type's bonus gives.
	 * @param bonusKing
	 *            The bonus king.
	 */
	...
	/**
	 * Returns the status of the bonus type. If true, the bonus is already
	 * available.
	 * 
	...
	/**
	 * Runs the bonus associated to the type and sets the status of the bonus at
	 * false.
	 * 
	 * @param player
	...
	public void runBonusType(Player player) {
		if (bonusAvailable && completedType(player) && bonusKing != null) { // Excute
																			// the
																			// bonus
																			// if
																			// it's
