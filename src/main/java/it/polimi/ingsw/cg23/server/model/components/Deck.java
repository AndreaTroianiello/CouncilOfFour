...
/**
 * The Deck contains the all politic cards of the game. If you discard a card,
 * it is put in this object.
 * 
 * @author Andrea
 *
 */
public class Deck implements Serializable {
	...
	/**
	 * The constructor of Deck. Initializes the principal list of politic cards
	 * and the list of discarded cards Also shuffles the principal list.
	 * 
	 * @param politicCards
	 */
	 ...
	 * 
	 * @return the first politic card of the main deck (remove it).Returns null
	 *         if Deck doesn't contain politic cards.
	 */
	...
	/**
	 * If the discarded deck is not empty changes it with the main deck and
	 * shuffles. Clears the discarded deck.
	 */
	private void changeDeck() {
		if (!discardedCards.isEmpty()) { // If the discarded deck isn't empty do
											// it
	 ...
	 * 
	 * @param politicCards
	 *            the cards that need to shuffle.
	 */
	private void shuffleDeck() {
		...
		for (int index = politicCards.size(); index > 0; index--) {
			...
			PoliticCard cards = politicCards.remove(randomIndex); // Removes the
																	// card at
																	// the
																	// random
																	// index.
