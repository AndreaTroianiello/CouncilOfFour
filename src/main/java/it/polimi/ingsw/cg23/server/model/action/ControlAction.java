...
/**
 * the class that controls if the parameter passed to the action are actually in
 * the board
 * 
 * @author Vincenzo
 *
...
public class ControlAction implements Serializable {
	 ...
	 * 
	 * @param controlledRegion
	 *            the region to be controlled
	 * @param board
	 *            the model of the game
