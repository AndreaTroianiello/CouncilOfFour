...
public class MarketSell extends GameAction implements MarketAction {
	 ...
	 * @param item The assistants pool that contains the assistants to search.
	 ...
	 * @param item The politic card to search.
	 ...
	 * @param item The business permit tile to search.
