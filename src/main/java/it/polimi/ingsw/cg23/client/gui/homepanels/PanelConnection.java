...
public class PanelConnection extends JPanel {
	...
	private void initComponent() {
		...
		panelLayout.setHorizontalGroup(panelLayout.createParallelGroup(Alignment.LEADING).addGroup(Alignment.TRAILING,
				panelLayout.createSequentialGroup().addGap(33, 33, 33).addComponent(labelAddress).addGap(18, 18, 18)
						.addGroup(panelLayout.createParallelGroup(GroupLayout.Alignment.TRAILING)
								.addGroup(panelLayout.createSequentialGroup().addComponent(buttonSocket)
										.addGap(104, 104, 104).addComponent(buttonRMI))
								.addComponent(fieldAddress, GroupLayout.PREFERRED_SIZE, 226,
										GroupLayout.PREFERRED_SIZE))
						.addContainerGap(67, Short.MAX_VALUE)));
		panelLayout.setVerticalGroup(panelLayout.createParallelGroup(Alignment.LEADING).addGroup(panelLayout
				.createSequentialGroup().addGap(105, 105, 105)
				.addGroup(panelLayout.createParallelGroup(Alignment.BASELINE).addComponent(labelAddress).addComponent(
						fieldAddress, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
				.addGap(18, 18, 18).addGroup(panelLayout.createParallelGroup(Alignment.BASELINE)
						.addComponent(buttonSocket).addComponent(buttonRMI))
	...
	private void buttonSocketActionPerformed() {
		try {
			...
			logger.error(e);
			JOptionPane.showMessageDialog(null, "Unable to contact server with a SOCKET connection.", "ERROR",
	...
	private void buttonRMIActionPerformed() {
		try {
			...
			logger.error(e);
			JOptionPane.showMessageDialog(null, "Unable to contact server with a RMI connection.", "ERROR",
					JOptionPane.WARNING_MESSAGE);
		}
	}
