...
public class PlayerStatic extends JFrame {
	...
	public void createGrid(Player p) {
		...
		// ----------nome utente----------
		JLabel userLabel = new JLabel("Point " + p.getUser());// aggiungo
																// l'immagine
																// alla label
		...
		JLabel vicotrypoint = new JLabel(new ImageIcon(img1));// aggiungo
																// l'immagine
																// alla label
		...
		JLabel vicotrLabel = new JLabel("The victory points you have");// aggiungo
																		// l'immagine
																		// alla
																		// label
		...
		JLabel coin = new JLabel(new ImageIcon(img2));// aggiungo l'immagine
														// alla label
		...
		// ----------coin descrizione---------
		JLabel coinLabel = new JLabel("Your coins");// aggiungo l'immagine alla
													// label
		...
		JLabel nobilityTrack = new JLabel(new ImageIcon(img3));// aggiungo
																// l'immagine
																// alla label
		...
		JLabel nobilityLabel = new JLabel("Your nobility box position");// aggiungo
																		// l'immagine
																		// alla
																		// label
		...
		JLabel assistant = new JLabel(new ImageIcon(img4));// aggiungo
															// l'immagine alla
															// label
		...
		JLabel assistantLabel = new JLabel("Your assistants");// aggiungo
																// l'immagine
																// alla label
	 ...
	 *            the image name
	 * @param num,
	 *            the text to write over the image @return, a buffered image
	 */
	private Image createImage(String name, int num) {
		...
		return img.getScaledInstance((int) width, (int) height, Image.SCALE_DEFAULT);// ridimensionamento
																						// immagine

	}

	/**
	 * coin image height @return, the coin image height
	 */
	 ...
	 * 
	 * @param name,
	 *            the image name @return, the image
	 */
	private BufferedImage getImg(String name) {// recupero l'immagine della
												// carta costruzione
		BufferedImage image = null;
		String path = "src/main/resources/images/stat/" + name + ".png";// percorso
																		// dell'immagine
