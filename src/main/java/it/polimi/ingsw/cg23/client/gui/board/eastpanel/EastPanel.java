...
public class EastPanel extends JPanel {
	...
	private void init() {
		...
		loggerArea.setFont(new Font("Calibre", Font.PLAIN, 15));// font
																// loggerArea
		Component scrollLogger1 = new JScrollPane(loggerArea);// scroller
																// loggerArea
		...
		layout.setConstraints(scrollLogger1, lim);// applicazione del layout
													// allo scroller
		...
		layout.setConstraints(write, lim);// applicazione del layout alla write
											// area
		add(write);// aggiunta write area al pannello

		write.addMouseListener(new MouseListener() {// azioni pannello click
													// mouse
			@Override
		...
		layout.setConstraints(button3, lim); // applicazione del layout al
												// bottone
		...
		layout.setConstraints(buttonPanel, lim);// applicazione del layout al
												// button panel
