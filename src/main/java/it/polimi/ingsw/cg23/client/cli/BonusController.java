...
/**
 * Class that handles the translation of commands when you have received a
 * bonus.
 * 
 * @author Andrea
 *
...
public class BonusController {
	...
	/**
	 * Search if each city in the string are in the model, and add in cities the
	 * ones that are in it
	 * 
	 * @param string
	 *            The names of the cities to be searched
	 * @param parameters
	 *            The number of cities to be searched
