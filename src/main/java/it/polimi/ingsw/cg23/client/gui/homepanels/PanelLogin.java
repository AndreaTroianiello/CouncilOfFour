...
public class PanelLogin extends JPanel {
	...
	private void initComponent() {
		...
		comboMap.setModel(new DefaultComboBoxModel<>(
				new String[] { "Map 1", "Map 2", "Map 3", "Map 4", "Map 5", "Map 6", "Map 7", "Map 8" }));

		GroupLayout panelLogginLayout = new GroupLayout(this);
		this.setLayout(panelLogginLayout);
		panelLogginLayout.setHorizontalGroup(panelLogginLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
				.addGroup(panelLogginLayout.createSequentialGroup().addGap(137, 137, 137).addComponent(labelInfo1)
				...
				.addGroup(panelLogginLayout.createSequentialGroup()
						.addGroup(panelLogginLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
								.addGroup(panelLogginLayout.createSequentialGroup().addGap(152, 152, 152)
										.addGroup(panelLogginLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
												.addGroup(panelLogginLayout.createSequentialGroup().addGap(10, 10, 10)
														.addComponent(labelInfo2))
												.addComponent(buttonLogin)))
								.addGroup(panelLogginLayout.createSequentialGroup().addGap(23, 23, 23)
										.addGroup(panelLogginLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
												.addComponent(labelLogin).addComponent(labelMap))
								.addPreferredGap(ComponentPlacement.RELATED)
								.addGroup(panelLogginLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
										.addGroup(panelLogginLayout.createSequentialGroup()
												.addComponent(comboMap, GroupLayout.PREFERRED_SIZE,
														GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
												.addGap(0, 0, Short.MAX_VALUE))
										.addComponent(fieldLogin))))
						.addGap(12, 12, 12)));
		panelLogginLayout.setVerticalGroup(panelLogginLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
				.addGroup(panelLogginLayout.createSequentialGroup().addGap(73, 73, 73).addComponent(labelInfo1)
						.addGap(3, 3, 3)
						.addGroup(panelLogginLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
								.addComponent(labelLogin).addComponent(fieldLogin, GroupLayout.PREFERRED_SIZE,
										GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
						.addGap(18, 18, 18)
						.addGroup(panelLogginLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
								.addComponent(labelMap).addComponent(comboMap, GroupLayout.PREFERRED_SIZE,
										GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
						.addGap(9, 9, 9).addComponent(buttonLogin).addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(labelInfo2).addContainerGap(20, Short.MAX_VALUE)));
	...
	private void buttonLoginActionPerformed() {
		...
		map = map.substring(0, map.length() - 2) + map.charAt(map.length() - 1);// tolgo
																				// lo
																				// spazio
