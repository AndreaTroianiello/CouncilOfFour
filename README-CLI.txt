...
CREATION userName nameMap(map*number* 1<=number<=8, ex. map1)
...
BUILDKING cityName
The name of the city must be written with the first letter uppercase and the rest of the name lowercase.
...
The name of the region must be written with the first letter uppercase and the rest of the name lowercase.
...
The name of the region must be written with the first letter uppercase and the rest of the name lowercase.
The name of the color must be written with the first letter uppercase and the rest of the name lowercase and
